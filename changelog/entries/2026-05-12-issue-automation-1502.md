...
- 2026-05-12 15:02:53 CST：`正在执行`，取得 changelog 工作锁，开始 GitHub 权限检查与 issue 选择准备。
- 2026-05-12 15:03:50 CST：`已跳过`，`gh auth status` 未通过，释放 changelog 工作锁。
...
- `changelog/entries/2026-05-12-issue-automation-1502.md`：记录本轮自动化跳过原因。
